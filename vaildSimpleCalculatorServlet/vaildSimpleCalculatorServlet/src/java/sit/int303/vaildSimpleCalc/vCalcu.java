 ...
 * @author INT303
 */
@WebServlet(name = "vCalcu", urlPatterns = {"/vCalcu"})
public class vCalcu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String oStr = request.getParameter("o");
...
//            }
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet vCalcu</title>");            
            out.println("</head>");
            out.println("<body>");
